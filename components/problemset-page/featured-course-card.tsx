...
function FeaturedCourseCard({ cardTitle = "Leetcode's Interview Crash Course:", cardDesc = "System Design for Interviews and Beyond", redirectUrl = '/problemset'} : FeaturedCardProps) {
  return (
